...
class DestinationConfigSerializerTests(TestCase):
    ...
    def test_validate_new_email_destination_with_incorrect_settings(self):
        request = self.request_factory.post("/")
        request.user = self.user
        data = {
            "media": "email",
    ...
    def test_validate_new_email_destination_with_incorrect_email(self):
        request = self.request_factory.post("/")
        request.user = self.user
        data = {
            "media": "email",
    ...
    def test_validate_new_email_destination_with_extra_settings(self):
        request = self.request_factory.post("/")
        request.user = self.user
        data = {
            "media": "email",
    ...
    def test_validate_new_sms_destination_with_incorrect_settings(self):
        request = self.request_factory.post("/")
        request.user = self.user
        data = {
            "media": "sms",
    ...
    def test_validate_new_sms_destination_with_incorrect_number(self):
        request = self.request_factory.post("/")
        request.user = self.user
        data = {
            "media": "sms",
    ...
    def test_validate_new_sms_destination_with_extra_settings(self):
        request = self.request_factory.post("/")
        request.user = self.user
        data = {
            "media": "sms",
